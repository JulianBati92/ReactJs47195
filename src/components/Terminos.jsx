...
¡Bienvenido a https://react-js47195.vercel.app/!

Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de Tu Matteoli, ubicado en https://react-js47195.vercel.app/.

Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones. No continúes usando https://react-js47195.vercel.app/ si no estás de acuerdo con todos los términos y condiciones establecidos en esta página.
...
Licencia:
A menos que se indique lo contrario, Tu Matteoli y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en https://react-js47195.vercel.app/. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde https://react-js47195.vercel.app/ para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.

No debes:

Copiar o volver a publicar material de https://react-js47195.vercel.app/
Vender, alquilar o sublicenciar material de https://react-js47195.vercel.app/
Reproducir, duplicar o copiar material de https://react-js47195.vercel.app/
Redistribuir contenido de https://react-js47195.vercel.app/
Este acuerdo comenzará el fecha presente.

Partes de este sitio web ofrecen a los usuarios la oportunidad de publicar e intercambiar opiniones e información en determinadas áreas. Tu Matteoli no filtra, edita, publica ni revisa los comentarios antes de su presencia en el sitio web. Los comentarios no reflejan los puntos de vista ni las opiniones de Tu Matteoli, sus agentes y/o afiliados. Los comentarios reflejan los puntos de vista y opiniones de la persona que publica. En la medida en que lo permitan las leyes aplicables, Tu Matteoli no será responsable de los comentarios ni de ninguna responsabilidad, daños o gastos causados ​​o sufridos como resultado de cualquier uso o publicación o apariencia de comentarios en este sitio web.

Tu Matteoli se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos Términos y Condiciones.
...
Por la presente, otorgas a Tu Matteoli una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de tus comentarios en todas y cada una de las formas, formatos, o medios.
...
Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a Tu Matteoli. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta.
...
No se permitirá el uso del logotipo de Tu Matteoli u otro material gráfico para vincular sin un acuerdo de licencia de marca comercial.
